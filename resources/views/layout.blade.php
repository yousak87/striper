        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-lg"><b>Striper</b>Apps</span>
                </a>
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    @if(Session::get('gambar')!='')
                                    <img src="{{ URL::asset('uploads')}}/{{Session::get('gambar')}}" width="25px" height="25px" class="user-image" alt="User Image">
                                    @else
                                    <img src="{{ URL::asset('dist/img/user2-160x160.jpg')}}" width="25px" height="25px" class="img-circle" alt="User Image">
                                    @endif
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        <img src="{{ URL::asset('uploads')}}/{{Session::get('gambar')}}" class="img-circle" alt="User Image">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            <a href="#">
                                <i class="fa fa-dashboard"></i> <span>User Data Management</span> <i class="fa fa-angle-left pull-right"></i>
                            </a>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li>
                                    <a href="#"><i class="fa fa-circle-o"></i>Shift 1<i class="fa fa-angle-left pull-right"></i></a>
                                    <ul class="treeview-menu">

                                        <li>
                                            <a href="#"><i class="fa fa-circle-o"></i>Subjig<i class="fa fa-angle-left pull-right"></i></a>
                                            <ul class="treeview-menu">
                                                <li><a href="#"><i class="fa fa-circle-o"></i>K60</a></li>
                                                <li><a href="#"><i class="fa fa-circle-o"></i>K25</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#"><i class="fa fa-circle-o"></i>Mainjig</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#"><i class="fa fa-circle-o"></i>Shift 2<i class="fa fa-angle-left pull-right"></i></a>
                                    <ul class="treeview-menu">
